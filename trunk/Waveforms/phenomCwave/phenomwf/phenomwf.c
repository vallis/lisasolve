...
const double eulergamma = 0.5772156649015328606065120900824024;
const double pi   = 3.141592653589793; 
const double mtsun = 4.92549095e-6; /* geometrized solar mass, s */
const double mrsun = 1.47662504e3;  /* geometrized solar mass, m */
const double mpc = 3.0856775807e22; /* one MPc in m */
                  ...
                  taylorPars *tparams )
{
  ...
  double *Amp22 , fractionre , fractionim;
			 ...
			 double sigma)
{
  ...
  out = sigma / (2.0 * pi * ((freq - fRing)*(freq - fRing)
			       + sigma*sigma / 4.0));
