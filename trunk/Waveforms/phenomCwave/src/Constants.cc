...
/******************  CVS info ************************ 
#define CVSTAG "$Name:  $"
#define CVSHEADER "$Header: /afs/aeiw/cvsroot/waves/people/stas/LISAWP/base/src/Constants.cc,v 1.1 2007/09/18 21:50:40 stba Exp $" 
*/
...
const double LISAWP_EPSILON0_SI = 8.8541878176203898505365630317107503e-12L;
  ...
  //const std::string GEOhoftChannelName = "NotYetSet"; // the name of the GEO h(t) channel
  //char *newQualChanNames[5] = {"G1:DER_LOCK_MCO","G1:DER_LOCK_MID","G1:DER_LOCK_MC2",\
				"G1:DER_LOCK_MC1","G1:DER_LOCK_SL"};
} // end of namespace
