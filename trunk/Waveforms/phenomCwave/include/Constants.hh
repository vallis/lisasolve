...
/******************  CVS info ************************ 
#define CVSTAG "$Name:  $"
#define CVSHEADER "$Header: /afs/aeiw/cvsroot/waves/people/stas/LISAWP/base/include/Constants.hh,v 1.1 2007/09/18 21:50:36 stba Exp $" 
*/
...
namespace LISAWP{
  ...
  // Name of the h(t) channel name
//  extern const std::string GEOhoftChannelName; // the name of the GEO h(t) channel
  // Name of the new Quality Channels;
//  extern char *newQualChanNames[5];      
} // end of namespace
#endif
